...
const Privacy = () => {
  return (
    <Container>
      <p>Konrad Hefelle, Erlenweg 4, 8910 Affoltern am Albis, ist Betreiber dieser Webseite, abrufbar
      auf hausinaffoltern.online. Der Betrieber ist verantwortlich für die Erhebung, Verarbeitung
      und Nutzung Ihrer Daten und hat die Vereinbarkeit mit dem Schweizer Recht und allenfalls
      darüber hinaus anwendbaren europäischen Recht sicherzustellen.</p>

      <p>Wir nehmen den Schutz Ihrer persönlichen Daten sehr ernst. Wir behandeln Ihre
      ...
      dieser Daten bei uns veranlassen können.</p>

      <p>In Zusammenarbeit mit unseren Hosting-Providern bemühen wir uns, die Datenbanken so
      ...
      <p>Durch die Nutzung dieser Webseite erklären Sie sich mit der Erhebung, Verarbeitung und
      ...
      <p>Personendaten sind alle Angaben, die sich auf eine bestimmte oder bestimmbare Person
      ...
      <p>Wir bearbeiten Personendaten im Einklang mit dem schweizerischen Datenschutzrecht. Im
      ...
      Zusammenhang mit Art. 6 Abs. 1 DSGVO:</p>
      <ul>
      <li>lit. a) Bearbeitung von Personendaten mit Einwilligung der betroffenen Person.</li>

      <li>lit. b) Bearbeitung von Personendaten zur Erfüllung eines Vertrages mit der betroffenen
      Person sowie zur Durchführung entsprechender vorvertraglicher Massnahmen.</li>

      <li>lit. c) Bearbeitung von Personendaten zur Erfüllung einer rechtlichen Verpflichtung, der wir
      gemäss allenfalls anwendbarem Recht der EU oder gemäss allenfalls anwendbarem Recht
      eines Landes, in dem die DSGVO ganz oder teilweise anwendbar ist, unterliegen.</li>

      <li>lit. d) Bearbeitung von Personendaten um lebenswichtige Interessen der betroffenen Person
      oder einer anderen natürlichen Person zu schützen.</li>

      <li>lit. f) Bearbeitung von Personendaten um die berechtigten Interessen von uns oder von
      ...
      Einhaltung von schweizerischem Recht.</li>
      </ul>

      <p>Wir bearbeiten Personendaten für jene Dauer, die für den jeweiligen Zweck oder die
      ...
      Bearbeitung entsprechend ein.</p>

      <h3>2 ERHEBUNG, NUTZUNG UND VERARBEITUNG PERSONENBEZOGENER DATEN</h3>
      <h4>2.1 Weitergabe an Dritten</h4>

      <p>Wir geben Ihre Daten nur dann weiter, wenn wir dazu gesetzlich, durch behördliche oder
      ...
      für die Zukunft zu widerrufen.<br />
      ...
      Löschungsbegehren nachgekommen.<br />
